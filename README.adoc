...
If you’re already using ns-3.26 or a newer version you can download the blood-voyager-s folder and put it in the src folder. For further instructions see "Run BVS".

=== You're new to ns-3

You need to download the complete ns-3.26 (or newer) and follow the instructions in this  https://www.nsnam.org/docs/tutorial/html/getting-started.html[ns-3 tutorial]. Then you download the blood-voyager-s folder from here and put it in the src folder. For further instructions see "Run BVS".
